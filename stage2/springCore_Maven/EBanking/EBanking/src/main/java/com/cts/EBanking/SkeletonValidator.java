...
public class SkeletonValidator {
	...
	public  SkeletonValidator(){
		validateClassName("com.cts.EBanking.BankAccount");
		validateMethodSignature(
				"doDeposit:double,doWithdraw:"
				+ "double,calculateFixedAccount:double,calculateRecurringAccount:" 
				+ "double","com.cts.EBanking.BankAccount");
		validateClassName("com.cts.EBanking.SmartBankAccount");
		validateMethodSignature(
				"doDeposit:double,doWithdraw:"
				+ "double,calculateFixedAccount:double,calculateRecurringAccount:"
				+ "double","com.cts.EBanking.SmartBankAccount");
