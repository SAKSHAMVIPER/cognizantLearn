...
public class SkeletonValidator {
	...
	public SkeletonValidator() {
		validateClassName("com.cts.engineAnalysis.Car");
		validateMethodSignature("getReport:void", "com.cts.engineAnalysis.Car");

		validateClassName("com.cts.engineAnalysis.DieselEngine");
		validateMethodSignature("getPerformance:int", "com.cts.engineAnalysis.DieselEngine");

		validateClassName("com.cts.engineAnalysis.PetrolEngine");
		validateMethodSignature("getPerformance:int", "com.cts.engineAnalysis.PetrolEngine");
